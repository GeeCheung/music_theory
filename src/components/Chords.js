...
const getChord = (note) =>  {
  ...
  return (
    <div>
      ...
      <div className='subh'>
      <Buttons color={"light"} text={"Get Dominant 5th"} id = {"fifth"} selectedChord={selectedChord} onClick={() =>  handleChordClick(note, scales = "Major", whatchord ="fifth")} ></Buttons>
      <Buttons color={"light"} text={"Get 7th chord"} id = {"7th"} selectedChord={selectedChord} onClick={() => handleChordClick(note, scales = "Major", whatchord= "7th")} ></Buttons>
      <Buttons color={"light"} text={"Get 9th chord"} id = {"9th"} selectedChord={selectedChord} onClick={() => handleChordClick(note, scales = "Major", whatchord= "9th")} ></Buttons>
      <Buttons color={"light"} text={"Get Relative Minor"}  id = {"relative_minor"} selectedChord={selectedChord} onClick={() => handleChordClick(note, scales = "Major", whatchord ="relative_minor")} ></Buttons>
